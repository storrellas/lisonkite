...
echo ("<p>Question1:".$_POST["page0_question1"]."</p>");
echo ("<p>Question2:".$_POST["page0_question2"]."</p>");
echo ("<p>Question3:".$_POST["page0_question3"]."</p>");
echo ("<p>Question4:".$_POST["page0_question4"]."</p>");
echo ("<p>Question5:".$_POST["page0_question5"]."</p>");
echo ("<p>Question6:".$_POST["page0_question6"]."</p>");
echo ("<p>Question7:".$_POST["page0_question7"]."</p>");
echo ("<p>Question8:".$_POST["page0_question8"]."</p>");
