		...
		<div id=page_0 style="padding: 20px">			
			<div style="border: 3px solid black; border-radius: 20px; padding: 20px;">
				...
				<div id="question1" class="question">
					...
					<div>
					 <input type="radio" name="question1" value="question1_A" checked="checked">A - Valvula a la Izquierda<br>
				...
				<div id="question7" class="question">
					...
					<p>Desde el centro de la valvula hasta la sellada en la base de la costilla.</p>
					<div>
					 <input type="radio" name="question7" value="question6_A" checked="checked">A - Standard sin stoper<br>
					 <input type="radio" name="question7" value="question6_B">B - Standard con stoper de membrana ( retiene el aire si sacas el inflador )<br>
					 <input type="radio" name="question7" value="question6_C">C - Standard con stoper de bola ( retiene el aire si sacas el inflador )<br>
					 <input type="radio" name="question7" value="question6_D">D - One pump negro ( Ozone, Slingshot.... )<br>
					 <input type="radio" name="question7" value="question6_E">E - One pump azul ( Best, North.... )<br>
				...
				<div id="question8" class="question">
					...
					<div>
						<input type="radio" name="question8" value="question7_A" checked="checked">A<br>
				 		<input type="radio" name="question8" value="question7_B">B<br>
						<input type="radio" name="question8" value="question7_C">C<br>
		...
		<div id=page_1 style="padding: 20px">					
			<div style="border: 3px solid black; border-radius: 20px; padding: 20px;">
				...
				<div class="question">
					...
					<textarea id="doubts" name="doubts" cols="40" rows="5"></textarea>
				</div>
				
				<div class="question">
					<div class="title">¿Cómo prefieres que nos pongamos en contacto contigo?</div>
					<div>
						<input type="radio" name="contact_type" value="whatsapp" checked="checked">Wassssssuppp<br>
				 		<input type="radio" name="contact_type" value="telefono">Teléfono<br>
						<input type="radio" name="contact_type" value="mail">mail<br>
					</div>
				</div>
